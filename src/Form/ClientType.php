...
class ClientType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('creerCompte', CheckboxType::class, [
                ...
                'attr' => [
                    'class' => 'sr-only',
                    'onchange' => 'toggleAccountFields()', // Appel à la fonction JavaScript
                ],
            ]);

        // Champs utilisateur (affichés seulement si "Créer un compte" est coché)
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => Client::class, // Liaison avec l'entité Client
        ]);
    }
}
